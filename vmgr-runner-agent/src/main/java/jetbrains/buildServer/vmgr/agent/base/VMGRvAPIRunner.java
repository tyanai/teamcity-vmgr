...
import jetbrains.buildServer.vmgr.agent.vapi.VAPIProcessAdapter;
...
public class VMGRvAPIRunner extends BaseVMGRRunner {


    @NotNull
    private final InternalPropertiesHolder myInternalProperties;

    public VMGRvAPIRunner(@NotNull final ExtensionHolder extensionHolder,
    ...
    protected BuildProcess getDeployerProcess(@NotNull final BuildRunnerContext context,
        ...
        return new VAPIProcessAdapter(context, artifactsCollections, pluginParams);
